...
const rList = [
  {
    ...
    price: "12 000 грн",
    description:
      "Углубленный курс по безопасным канюльным техникам в эстетической медицине с отработкой на моделях.",
  },
  {
    id: 2,
    type: "course",
    ...
    price: "8 500 грн",
    description:
      "Полный базовый курс по мезотерапевтическим препаратам, мезококтейлям и техникам введения.",
  },
  {
    id: 3,
    type: "master",
    ...
    price: "5 000 грн",
    description:
      "Инновационные протоколы работы с биогелями. Мастер-класс с постановкой руки.",
  },
  {
    id: 4,
    type: "video",
    category: "Онлайн обучение",
    subCategory: "Эстетическая косметология",
    title: "Массаж лица",
    speaker: "Елена Белогурова",
    youtubeId: "ysz5S6PUM-U",
    image: man,
    price: "3 200 грн",
    description:
      "Авторская техника скульптурного массажа лица для практикующих эстетистов.",
  },
  {
    id: 5,
    type: "course",
    category: "Курсы по косметологии",
    subCategory: "Эстетическая косметология",
    title: "Анатомия лица для косметологов",
    format: "Оффлайн",
    date: "10 - 12 июня",
    theme: "purple",
    freeSpots: 4,
    ...
    price: "15 000 грн",
    description:
      "Клиническая анатомия опасных зон лица для предотвращения осложнений.",
  },
  {
    id: 6,
    type: "video",
    category: "Онлайн обучение",
    subCategory: "Инъекционная косметология",
    title: "Актуальна ли мезотерапия в коррекции шей?",
    speaker: "Марина Спивак",
    youtubeId: "dQw4w9WgXcQ",
    image: man,
    price: "2 800 грн",
    description:
      "Разбор сложных кейсов и эффективных коктейлей для зоны шеи и декольте.",
  },
  {
    id: 7,
    type: "master",
    ...
    price: "7 000 грн",
    description:
      "Техники «Плоские губы», «Russian Lips» и естественное моделирование.",
  },
  {
    id: 8,
    type: "course",
    category: "Курсы по косметологии",
    subCategory: "Лазерная косметология",
    ...
    price: "10 000 грн",
    description:
      "Лазерные технологии, РФ-лифтинг, ультразвуковой смас-лифтинг в практике.",
  },
  {
    id: 9,
    type: "video",
    category: "Онлайн обучение",
    subCategory: "Эстетическая косметология",
    title: "Чистка лица: базовые протоколы",
    speaker: "Ольга Петрова",
    youtubeId: "3JZ_D3ELwOQ",
    image: man,
    price: "2 500 грн",
    description:
      "Современные комбинированные чистки, выбор косметицевских линеек.",
  },
  {
    id: 10,
    type: "master",
    ...
    price: "9 000 грн",
    description:
      "Верхняя треть лица, ботулинорезистентность и работа с мимическими морщинами.",
  },
  {
    id: 11,
    type: "course",
    category: "Курсы по косметологии",
    subCategory: "Эстетическая косметология",
    title: "Пилинги нового поколения",
    format: "Оффлайн",
    date: "18 сентября",
    theme: "purple",
    freeSpots: 3,
    ...
    image: maniken,
    price: "6 000 грн",
    description: "Всесезонные мультикислотные пилинги и постпилинговый уход.",
  },
  {
    id: 12,
    type: "video",
    category: "Онлайн обучение",
    subCategory: "Эстетическая косметология",
    title: "Карбокситерапия в кабинете",
    speaker: "Анна Коваль",
    youtubeId: "ysz5S6PUM-U",
    image: man,
    price: "2 100 грн",
    description:
      "Неинвазивная карбокситерапия для мгновенного лифтинга и сияния кожи.",
  },
  {
    id: 13,
    type: "master",
    ...
    price: "11 000 грн",
    description:
      "Работа с коллагенстимулирующими препаратами для лифтинга кожи.",
  },
  {
    id: 14,
    type: "course",
    category: "Курсы по косметологии",
    subCategory: "Эстетическая косметология",
    title: "Трихология для эстетистов",
    format: "Онлайн",
    date: "12 октября",
    theme: "green",
    freeSpots: 4,
    ...
    image: maniken,
    price: "9 500 грн",
    description: "Диагностика выпадения волос, мезотерапия кожи головы.",
  },
  {
    id: 15,
    type: "video",
    category: "Онлайн обучение",
    subCategory: "Лазерная косметология",
    title: "Работа с пигментацией",
    speaker: "Елена Белогурова",
    youtubeId: "dQw4w9WgXcQ",
    image: man,
    price: "3 000 грн",
    description: "Протоколы осветления кожи и борьба с меланозом.",
  },
  {
    id: 16,
    type: "master",
    ...
    image: man,
    price: "18 000 грн",
    description: "Установка мезонитей с насечками, создание каркаса лица.",
  },
  {
    id: 17,
    type: "course",
    category: "Курсы по косметологии",
    subCategory: "Эстетическая косметология",
    title: "Нутрицевтика в косметологии",
    format: "Онлайн",
    date: "10 ноября",
    theme: "green",
    freeSpots: 6,
    ...
    image: maniken,
    price: "7 500 грн",
    description: "Витамины, микроэлементы и БАДы для здоровья кожи изнутри.",
  },
  {
    id: 18,
    type: "video",
    category: "Онлайн обучение",
    subCategory: "Эстетическая косметология",
    title: "Анти-эйдж массаж",
    speaker: "Ольга Петрова",
    youtubeId: "3JZ_D3ELwOQ",
    image: man,
    price: "2 900 грн",
    description: "Глубокотканный массаж лица для разглаживания морщин.",
  },
  {
    id: 19,
    type: "master",
    category: "Мастер-классы",
    subCategory: "Лазерная косметология",
    title: "Лазерная эпиляция: теория и практика",
    format: "Мастер-класс",
    date: "15 ноября",
    theme: "teal",
    freeSpots: 3,
    ...
    image: man,
    price: "6 500 грн",
    description: "Работа на диодном и александритовом лазерах без ожогов.",
  },
  {
    id: 20,
    type: "course",
    category: "Курсы по косметологии",
    subCategory: "Эстетическая косметология",
    title: "Эстетика тела и целлюлит",
    format: "Оффлайн",
    date: "1 декабря",
    theme: "purple",
    freeSpots: 2,
    ...
    price: "13 000 грн",
    description:
      "Антицеллюлитные обертывания, лимфодренажный массаж и мезотерапия тела.",
  },
  {
    id: 21,
    type: "video",
    category: "Онлайн обучение",
    subCategory: "Эстетическая косметология",
    title: "Продвижение косметолога в соцсетях",
    speaker: "Марина Спивак",
    youtubeId: "ysz5S6PUM-U",
    image: man,
    price: "4 000 грн",
    description: "Как привлекать клиентов на процедуры через личный бренд.",
  },
  {
    id: 22,
    type: "master",
    category: "Мастер-классы",
    subCategory: "Лазерная косметология",
    title: "Дерматоскопия новообразований",
    format: "Мастер-класс",
    date: "10 декабря",
    theme: "teal",
    freeSpots: 2,
    ...
    image: man,
    price: "8 000 грн",
    description: "Диагностика кожи перед удалением родинок и папиллом.",
  },
];
...
export const Home = () => {
  ...
  const filteredCourses = rList.filter((item) => {
    ...
    if (activeTab === "Онлайн обучение")
      return item.category === "Онлайн обучение" || item.type === "video";
    if (activeTab === "Мастер-классы")
      return (
        item.category === "Мастер-классы" || item.format === "Мастер-класс"
      );
    return true;
  });
      ...
      <div className={styles.tabsContainer}>
        <div className={styles.tabsRow}>
          ...
          <div className={styles.dropdownWrapperDesktop} ref={dropdownRef}>
            ...
            >
              <span>
                {activeTab === "Курсы по косметологии" && selectedSubCategory
                  ? selectedSubCategory
          ...
          currentCourses.map((item, idx) => {
            ...
            if (item.type === "video") {
              return (
                <div
                  key={item.id}
                  className={`${styles.card} ${styles.greenTheme}`}
                  style={cardDelay}
                >
                  <div className={styles.cardTop}>
                    <div className={styles.cardHeader}>
                      ...
                      <img
                        src={birdIcon}
                        alt="bird"
                        className={styles.cardHeaderBirdIcon}
                      />
                    </div>
            ...
            return (
              ...
              >
                ...
                <div className={styles.cardBottom}>
                  <div
                    className={`${styles.footerInfo} ${isUrgent ? styles.footerInfoUrgent : ""}`}
                  >
            ...
            {modalType === "details" && (
              <div>
                ...
                <p className={styles.modalPrice}>
                  Стоимость: <strong>{selectedItem.price}</strong>
                </p>
                ...
                <div className={styles.modalActions}>
                  <button
                    ...
                    onClick={() =>
                      handleOpenModal(
                        selectedItem.type === "video" ? "buy" : "register",
                        selectedItem,
                      )
                    }
                  >
                    {selectedItem.type === "video"
                      ? `Купить видеоурок (${selectedItem.price})`
                      : "Записаться на курс"}
                  </button>
                </div>
              </div>
              ...
              <div>
                {isSuccess ? (
                  <div className={styles.successBox}>
                    ...
                    <p>
                      Менеджер учебного центра свяжется с вами в течение 10
                      минут для подтверждения бронирования.
                    </p>
                    <button
                      className={`${styles.modalBtnPrimary} ${getModalButtonThemeClass()}`}
              ...
              <div>
                {isSuccess ? (
                  <div className={styles.successBox}>
                    ...
                    <p>
                      Доступ к видео-уроку <b>«{selectedItem.title}»</b>{" "}
                  ...
                  <div>
                    ...
                    <p className={styles.modalSubtitle}>
                      Урок: <strong>{selectedItem.title}</strong> —{" "}
                    ...
                    <div className={styles.paymentMethodsTabs}>
                      <button
                        ...
                        onClick={() =>
                          setPayData({ ...payData, paymentMethod: "card" })
                        }
                      >
                        💳 Карта
                      </button>
                      <button
                        ...
                        onClick={() =>
                          setPayData({ ...payData, paymentMethod: "apple" })
                        }
                      >
                         Pay / G Pay
                      </button>
                    ...
                    >
                      ...
                      {payData.paymentMethod === "apple" && (
                        <div className={styles.digitalWalletsContainer}>
                          <p className={styles.walletHint}>
                            Выберите кошелек для мгновенной оплаты в 1 клик:
                          </p>
                          <div className={styles.walletButtonsRow}>
                            ...
                            <div
                              ...
                              onClick={() => setIsSuccess(true)}
                            >
                              <span className={styles.gText}>G</span>{" "}
                              <span>Pay</span>
                            </div>
                          </div>
                        </div>
                      ...
                      {payData.paymentMethod === "installments" && (
                        <div className={styles.installmentsBox}>
                          <p>
                            <b>Оплата частями без переплат:</b>
                          </p>
                          <p>• Доступно для клиентов ПриватБанк и Monobank.</p>
                          <p>
                            • Сумма разделяется на 3 равных ежемесячных платежа.
                          </p>
                        </div>
                      )}
...
export const ForCosms = () => (
  ...
  >
    ...
    <h1 style={{ color: "#1e293b", marginTop: "20px" }}>
      Курсы для косметологов
    </h1>
    <p style={{ color: "#64748b", lineHeight: "1.6", marginTop: "10px" }}>
      Подробная информация по всем направлениям обучения для практикующих
      врачей-косметологов.
    </p>
  </div>
);
